...
export const THEME_TOKEN_CSS_VARIABLES: Record<ThemeCssVarTokenKey, string> = {
  ...
  priorityUrgentBar: '--tt-priority-urgent-bar',
  priorityUrgentBarBorder: '--tt-priority-urgent-bar-border',
  priorityUrgentBarGlow: '--tt-priority-urgent-bar-glow',
  priorityDoneBar: '--tt-priority-done-bar',
  priorityDoneBarBorder: '--tt-priority-done-bar-border',
