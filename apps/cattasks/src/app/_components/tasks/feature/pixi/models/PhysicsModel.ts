import {Model} from '@/app/_components/tasks/feature/pixi/core/Model';
import {MovementEvents, PlayerEvents} from '@/app/_components/tasks/feature/pixi/core/EventTypes';
