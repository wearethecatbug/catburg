...
import {Scene} from "@/app/_components/tasks/feature/pixi/scene/Scene";
...
import {WORM_ANIMATION_NAME_MAP} from "@/app/_components/tasks/feature/pixi/entities/wormMonster/animations";
import {keyboardControllerSingleton} from "@/app/_components/tasks/feature/pixi/interactive/KeyboardController";
import {ActorFactory} from "@/app/_components/tasks/feature/pixi/factories/ActorFactory";
import {EntityAnimationState} from "@/app/_components/tasks/feature/pixi/systems/animation";
...
function buildScene() {
    ...
    if (WORM_ANIMATION_NAME_MAP.Attack) {
        wormActor.setState(<EntityAnimationState>WORM_ANIMATION_NAME_MAP.Attack);
    }
