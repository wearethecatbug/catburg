...
export { buildPublicCandidateCodes, chooseNextHintPredicate, evaluateEarnedHintFact, filterCandidateCodesByFact } from "./earned-hint-facts";
...
export type { EarnedHintFact, HintPredicate, PublicHintKnowledge } from "./earned-hint-facts";
